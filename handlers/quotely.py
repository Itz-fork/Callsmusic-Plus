...
async def quotly_func(client, message: Message):
    if not message.reply_to_message:
        return await message.reply_text("Please Reply To a Message To Quote It 😆!")
    if not message.reply_to_message.text:
        return await message.reply_text(
            "Sorry! Please Reply To a Text Message 🥺!"
        )
    ...
    if len(message.command) < 2:
        ...
        await m.edit(
            "Wrong Argument! Please hit on **/help** and Select 'Quotely' Module Help Section 😁!"
        )
        return
    try:
        ...
        await m.edit(
            "Oops! Something wrong happened while quoting messages,"
